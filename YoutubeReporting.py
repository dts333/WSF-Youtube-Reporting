...
try:
    bi21 = pd.DataFrame()
    for v in BI21:
        sn = service.reports().query(metrics='views', dimensions='day', ids='channel==MINE', filters='video=='+v, startDate='2008-01-01', endDate='2022-05-20').execute()
    ...
    bi212 = pd.DataFrame()
    for v in BI21:
        sn = service.reports().query(metrics='estimatedMinutesWatched', dimensions='day', ids='channel==MINE', filters='video=='+v, startDate='2008-01-01', endDate='2022-05-20').execute()
